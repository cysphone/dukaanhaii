...
export default function ElegantProductTemplate({ product, business, relatedProducts, waLink, waNumber }: Props) {
  ...
  return (
    <div className="min-h-screen bg-zinc-900 text-zinc-50 font-serif transition-colors duration-500">
      {/* Header */}
              ...
              {waNumber ? (
                product.inStock ? (
                  <a
                    ...
                    className="block w-full text-center text-lg font-bold py-4 transition-all flex items-center justify-center gap-2 bg-transparent text-amber-400 border border-amber-400 hover:bg-amber-400 hover:text-black rounded-sm uppercase tracking-widest"
                    style={{}}
                  >
