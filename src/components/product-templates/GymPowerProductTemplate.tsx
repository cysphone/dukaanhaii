...
export default function GymPowerProductTemplate({ product, business, relatedProducts, waLink, waNumber }: Props) {
  ...
  return (
    <div className="min-h-screen bg-black text-yellow-400 font-mono transition-colors duration-500">
      {/* Header */}
              ...
              {waNumber ? (
                product.inStock ? (
                  <a
                    ...
                    className="block w-full text-center text-lg font-bold py-4 transition-all flex items-center justify-center gap-2 bg-yellow-500 text-black border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-1 hover:translate-y-1 hover:shadow-none"
                    style={{}}
                  >
