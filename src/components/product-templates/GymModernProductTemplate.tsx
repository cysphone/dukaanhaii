...
export default function GymModernProductTemplate({ product, business, relatedProducts, waLink, waNumber }: Props) {
  ...
  return (
    <div className="min-h-screen bg-zinc-900 text-white font-sans transition-colors duration-500">
      {/* Header */}
              ...
              {waNumber ? (
                product.inStock ? (
                  <a
                    ...
                    className="block w-full text-center text-lg font-bold py-4 transition-all flex items-center justify-center gap-2 bg-red-500 hover:bg-red-500/90 text-white rounded-xl shadow-lg shadow-red-500/20 hover:-translate-y-1"
